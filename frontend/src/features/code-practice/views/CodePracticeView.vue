<!--
  组件名称：CodePracticeView（代码练习列表视图）
  功能描述：展示代码题库列表，支持按难度、标签、关键词筛选，显示提交状态。
-->
<template>
  <div class="max-w-7xl mx-auto px-4 py-4 sm:py-8 space-y-6">
    <section class="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-5">
      <div>
        <p class="text-sm font-semibold text-[#0066CC] uppercase tracking-wider mb-2">Interview ACM</p>
...
import api from '@/api'
import { formatShanghaiMonthDayTime } from '@/utils/datetime'
...
const formatDateTime = (dateStr) => {
  return formatShanghaiMonthDayTime(dateStr)
}
</script>
